...
window.CLEARWAVE_CATALOG = {
  ...
  // Regions by ZIP prefix (first three digits).
  regions: [
    { prefixes: ["200","202","203","204","205"], name: "Washington, DC", state: "DC", served: true, water: "DC Water uses chloramine (chlorine plus ammonia). It does not gas off like plain chlorine, so catalytic carbon is the right tool." },
